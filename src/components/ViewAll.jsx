...
const ViewAll = () => {
    const [data, changeData] = useState(
        ...
        { "userId": 3, "id": 22, "title": "et rem non provident vel ut" }, { "userId": 3, "id": 23, "title": "incidunt quisquam hic adipisci sequi" },
    ...
    return (
        <div>
            ...
            <div className="container">
                <div className="row col col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                    <div className="row">
                        {
                            data.map(
                                (value,index)=>{
                                    return <div className="col col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xcl-12">
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
